                    ...
                    <form id="contractForm">
                        ...
                        <div class="mt-2 text-center">
                            <small class="text-muted">
                                ...
                                After save, Word file will download automatically
                            </small>
                        </div>
                    </form>
                </div>
        ...
        axios.post(API_BASE, data)
            ...
            .catch(error => {
                ...
                if (error.response?.data?.errors) {
                    ...
                    showAlert('danger', error.response?.data?.message || 'Failed to create contract');
                }
                btn.prop('disabled', false).html('<i class="bi bi-check-lg me-1"></i>Save Contract');
            });
    }
